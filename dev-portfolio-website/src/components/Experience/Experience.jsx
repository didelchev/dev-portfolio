    ...
    <div className="experience-container" id="experience">
      ...
      <div className="job">
        ...
        <div className="job-description">
          <h4>GSM Security</h4>
          <h5 className="role current-role">Surveillance Operator</h5>
          <p>
      ...
      <div className="job">
        ...
        <div className="job-description">
          <h4>Genius Sports</h4>
          <h5 className="role current-role">Sports Event Analyst</h5>
          <p>
      ...
      <div className="job">
        ...
        <div className="job-description">
          ...
          <h5 className="role">Health and Safety Department Manager</h5>
          <p>
            ...
            Provided and monitored the use of personal protective equipment (PPE) for the cast and crew.
          </p>
        </div>
      </div>
      ...
      <div className="job">
        ...
        <div className="job-description">
          <h4>Nu Boyana Films</h4>
          <h5 className="role">Production Assistant</h5>
          <p>
